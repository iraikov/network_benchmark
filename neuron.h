...
public:
  ...
  vector<Neuron *> sources;	//Synapses				

  //Constructor & destructor
  ~Neuron();
  Neuron(Neuron **table_, Ncq *queue, double Vinit, double Vrinit, double Vtinit,double Elinit,double Eeinit, double Eiinit, double geinit, double giinit, double tausinit, double tauminit ,double dgiinit, double dgeinit, bool inhibiteur_, int id);
  /*Constructor :
